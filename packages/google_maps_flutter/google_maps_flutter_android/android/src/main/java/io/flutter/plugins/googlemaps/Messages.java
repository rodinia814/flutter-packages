...
public class Messages {
  ...
  public static final class PlatformMapViewCreationParams {
    ...
    static @NonNull PlatformMapViewCreationParams fromList(@NonNull ArrayList<Object> pigeonVar_list) {
      ...
      Object initialGroundOverlays = pigeonVar_list.get(8);
      pigeonResult.setInitialGroundOverlays((List<PlatformGroundOverlay>) initialGroundOverlays);
      Object initialClusterManagers = pigeonVar_list.get(9);
